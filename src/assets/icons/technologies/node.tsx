...
export const Nodejs = ({ size = 16, className, ...props }: IconProps) => (
  <svg
  ...
  >
    <path
      fill="url(#IconifyId19507057acbaad8990)"
    ...
    />
    <path
      fill="url(#IconifyId19507057acbaad8991)"
    ...
    />
    <path
      fill="url(#IconifyId19507057acbaad8992)"
    ...
    <defs>
      <linearGradient
        id="IconifyId19507057acbaad8990"
        x1="34.513"
        x2="27.157"
        y1="15.535"
        y2="30.448"
