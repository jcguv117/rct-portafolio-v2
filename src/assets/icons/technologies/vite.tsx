...
export const Vite = ({ size = 16, className, ...props }: IconProps) => (
  <svg
  ...
  >
    <defs>
      <linearGradient
        id="IconifyId195070681bbd00d350"
        x1="6"
        x2="235"
        y1="33"
        y2="344"
      ...
      <linearGradient
        id="IconifyId195070681bbd00d351"
        x1="194.651"
        x2="236.076"
        y1="8.818"
        y2="292.989"
    ...
    <path
      fill="url(#IconifyId195070681bbd00d350)"
    ...
    />
    <path
      fill="url(#IconifyId195070681bbd00d351)"
